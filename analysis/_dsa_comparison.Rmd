...
All `r comma(length(peaks))` consensus peaks were loaded and peaks widths were set to be `r fixed_width`bp.
This represents the `r percent(mean(width(peaks) < fixed_width)` percentile of the provided consensus peaks
